...
import 'schema/therapy_appointment_record.dart';
...
export 'schema/therapy_appointment_record.dart';
...
Future<FFFirestorePage<RecommendationRecord>> queryRecommendationRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query TherapyAppointmentRecords (as a Stream and as a Future).
Future<int> queryTherapyAppointmentRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TherapyAppointmentRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TherapyAppointmentRecord>> queryTherapyAppointmentRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<TherapyAppointmentRecord>> queryTherapyAppointmentRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<TherapyAppointmentRecord>>
    queryTherapyAppointmentRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
