...
class DashboardPageWidget extends StatefulWidget {
  ...
  final MoodTrackerRecord? isDoneEntry;
  final MoodTrackerRecord? dateTime;
                            ...
                            child: InkWell(
                              ...
                              child: Stack(
                                children: [
                                  Align(
                                    alignment:
                                        AlignmentDirectional(-0.51, 0.05),
                                    child: Text(
                                      'Check your progress\ntoday!',
                                  ...
                                  Align(
                                    alignment:
                                        AlignmentDirectional(-0.57, -0.72),
                                    child: Text(
                                      'Mood\nBud',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                              ...
                              child: InkWell(
                                ...
                                child: Stack(
                                  children: [
                                    Align(
                                      alignment:
                                          AlignmentDirectional(-0.16, -0.12),
                                      child: Text(
                                    ...
                                    Align(
                                      alignment:
                                          AlignmentDirectional(0.71, 0.88),
                                      child: Container(
                                        width: 100.0,
                                        height: 100.0,
                            ...
                            child: Stack(
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Image.asset(
                                    'assets/images/dasig_icons_(1).png',
                                    width: 100.0,
                                    height: 100.0,
                                    fit: BoxFit.cover,
                                  ),
                                ...
                                Align(
                                  alignment: AlignmentDirectional(-0.66, -0.6),
                                  child: Text(
                                    'Contact SWC',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
