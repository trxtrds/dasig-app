        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              asyncParams: {
                'isDoneMoodTracker':
                    getDoc(['moodTracker'], MoodTrackerRecord.fromSnapshot),
              },
            ...
            FFRoute(
              ...
              asyncParams: {
                'q1': getDoc(['moodTracker'], MoodTrackerRecord.fromSnapshot),
                'q2': getDoc(['moodTracker'], MoodTrackerRecord.fromSnapshot),
                'q3': getDoc(['moodTracker'], MoodTrackerRecord.fromSnapshot),
                'q4': getDoc(['moodTracker'], MoodTrackerRecord.fromSnapshot),
                'q5': getDoc(['moodTracker'], MoodTrackerRecord.fromSnapshot),
                'totalScore':
                    getDoc(['moodTracker'], MoodTrackerRecord.fromSnapshot),
                'date': getDoc(['moodTracker'], MoodTrackerRecord.fromSnapshot),
              },
            ...
            FFRoute(
              ...
              builder: (context, params) => ConfirmAppointmentWidget(),
            ),
            FFRoute(
              name: 'admin_login',
              path: 'adminLogin',
            ...
            FFRoute(
              name: 'selectTime',
              path: 'selectTime',
              builder: (context, params) => SelectTimeWidget(),
            ),
            FFRoute(
              name: 'displayAppointmentRequest',
              path: 'displayAppointmentRequest',
              asyncParams: {
                'date': getDoc(['therapy_appointment'],
                    TherapyAppointmentRecord.fromSnapshot),
                'time': getDoc(['therapy_appointment'],
                    TherapyAppointmentRecord.fromSnapshot),
                'userName': getDoc(['therapy_appointment'],
                    TherapyAppointmentRecord.fromSnapshot),
              },
              builder: (context, params) => DisplayAppointmentRequestWidget(
                date: params.getParam('date', ParamType.Document),
                time: params.getParam('time', ParamType.Document),
